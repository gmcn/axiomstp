...
function starting_theme_setup() {
	...
	add_image_size( 'gallery-large', 1200, 720, array( 'center', 'center' ) );

	// This theme uses wp_nav_menu() in one location.
	register_nav_menus( array(
		'nav__primary' => esc_html__( 'Primary', 'starting-theme' ),
		'nav__footer' => esc_html__( 'Footer - Top Links', 'starting-theme' ),
		'nav__signaure' => esc_html__( 'Signature', 'starting-theme' ),
		'menu-sidebar' => esc_html__( 'Sidebar Menu', 'starting-theme' ),
	) );
...
function remove_admin_menus() {
	...
	// Remove the Links tab by providing its slug
...
add_action('admin_menu', 'remove_admin_menus'); // Add our function to the admin_menu action
